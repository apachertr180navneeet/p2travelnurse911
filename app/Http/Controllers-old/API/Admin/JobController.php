    ...
    public function getJobs(Request $request)
    {
        ...
        try {
            ...
            $jobs = DB::table('jobs as j')
                ...
                ->select('j.id', 'j.title', 'j.unique_id', 'j.total_opening', 'j.created_at','j.is_starred','s.name as state_name', 'city.city_name', 'p.profession', 'sp.specialty','j.status','u.name',
                    'u.unique_id as user_unique_id','u.role_id as user_role_id',
