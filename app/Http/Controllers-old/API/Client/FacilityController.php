    ...
    public function getClients(Request $request)
    {
        ...
        try {
            $complianceFiles = DB::table('facilities as f')
                ...
                ->select('f.*','s.name as state_name', 'city.city_name')
    ...
    public function getAssignments(Request $request)
    {
        ...
        try {
            ...
            $complianceFiles = DB::table('assignments as a')
                    ...
                    if ($request->user_role_id == 2) {
                        $complianceFiles->leftJoin('users as u2', 'a.facility_id', '=', 'u2.id')
                                        ->select('a.facility_id as facility_title','a.confirmed_with_facility', 'a.confirmed_with_traveler', 'a.assigned_unit', 'a.assignment_length', 
                                        'a.shift', 'a.approved_time_off', 'a.facility_id', 'a.start_date', 'a.end_date', 'a.id', 'a.user_id', 'a.status', 'a.state_id', 'a.city_id', 
                                        'a.created_at', 's.name as state_name', 'city.city_name', 'u.name', 'u.unique_id as user_unique_id');
                    } else {
                        $complianceFiles->leftJoin('facilities as f', 'a.facility_id', '=', 'f.id')
                                        ->select('a.confirmed_with_facility', 'a.confirmed_with_traveler', 'a.assigned_unit', 'a.assignment_length', 'a.shift', 'a.approved_time_off', 
                                        'a.facility_id', 'a.start_date', 'a.end_date', 'a.facility_id as facility_title', 'a.id', 'a.user_id', 'a.status', 'a.state_id', 'a.city_id', 'a.created_at', 
                                        's.name as state_name', 'city.city_name', 'u.name', 'u.unique_id as user_unique_id');
                    }
            ...
            $complianceFiles = DB::table('assignments as a')
                ...
                'a.end_date','f.title as facility_title','a.id','a.user_id', 'a.status', 'a.state_id','a.city_id','a.created_at','s.name as state_name', 'city.city_name','u.name',
