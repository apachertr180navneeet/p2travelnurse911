    ...
    public function getSubmissions(Request $request)
    {
        ...
        try {
            $complianceFiles = DB::table('submissions as f')
                ...
                ->select('f.id', 'f.entry_date', 'f.candidate_id', 'f.client_id','f.specialty_id','f.agency_id','f.status','f.no_of_submissions', 'f.created_at','u.name','u.unique_id as user_unique_id',
