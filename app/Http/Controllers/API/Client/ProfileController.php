    ...
    public function getProfile(Request $request)
    {
        ...
        try {
            $user = DB::table('users as u')
                ...
                ->select('u.id as user_id', 'u.name', 'u.email', 'u.phone', 'u.country_code', 'u.profile_pic', 'ud.company_name', 'ud.website', 'ud.primary_industry', 'ud.company_size', 'ud.bio', 'ud.country_id', 'ud.state_id', 'ud.city_id', 'ud.address_line1', 'ud.address_line2', 'ud.founded_in', 'ud.social_media_links', 'c.name as country_name', 's.name as state_name', 's.code as state_code', 'city.city_name')
