...
class AuthController extends Controller
{
    ...
    public static function GetUser()
    {
        try {
             ...
             // Fetch users with role_id = 4, selecting only name & email, with pagination (20 per page)
    ...
    public static function VerifyUser(Request $request)
    {
        ...
        if ($validator->fails()) {
            return response()->json(['status' => false, 'message' => "Validation error occurred", 'errors' => $validator->errors()], 422);
        }
