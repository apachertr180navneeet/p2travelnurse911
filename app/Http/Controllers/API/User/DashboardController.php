    ...
    public function getDashboardData(Request $request)
    {
        ...
        try {
            ...
            $data['applied_job'] = DB::table('job_applications as ja')
                ...
                ->select('j.id', 'j.title', 'j.unique_id', 'ja.created_at', 's.name as state_name', 's.code as state_code',  'city.city_name', 'ja.status')
            ...
            */
            ...
            $data['profile_statistics'] = array(
                ...
                'resume_builder_progress' => $resume_builder_progress,
                'submission_file_builder_progress' => $submission_file_builder_progress,
                ''
            );
