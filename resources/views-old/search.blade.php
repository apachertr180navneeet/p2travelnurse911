   ...
   <div class="auto-container">
            ...
            <div class="filters-outer">
               ...
               <form method="GET">
                  ...
                  <div class="filter-block">
                     <h4>Location</h4>
                     <div class="form-group">
                        <input type="text" name="location" placeholder="City or State" value="{{ request('location') }}">
                  ...
                  <div class="filter-block">
                     ...
                     <div class="form-group">
                        <select class="chosen-select" name="empType">
                           ...
                           <option value="{{ $empType->id }}" {{ request('empType') == $empType->id ? 'selected' : '' }}>{{ $empType->title }}</option>
                           @endforeach
                        </select>
                  ...
                  <div class="filter-block">
                     ...
                     <div class="form-group">
                        <select class="chosen-select" name="orderBy">
                           ...
                           <option value="highest" {{ request('orderBy') == 'highest' ? 'selected' : '' }}>Highest Pay First</option>
                           <option value="lowest" {{ request('orderBy') == 'lowest' ? 'selected' : '' }}>Lowest Pay First</option>
                        </select>
                  ...
                  <div class="">
                     ...
                     <a href="{{ route('jobs-search') }}?type=listing" class="btn btn-secondary btn-block" style="padding-top:10px; padding-bottom:10px;padding:18px 35px 15px 35px; border-radius: 8px;font-size: 15px;line-height: 20px;">Reset</a>
      ...
      <div class="default-tabs tabs-box">
         <ul class="tab-buttons justify-content-center">
            <li class="tab-btn <?php if ((isset($_GET['type']) && $_GET['type'] == 'heatmap') || (!isset($_GET['type']))) echo 'active-btn'; ?>" data-tab="#heatMap" data-type="heatmap">Heat Map</li>
            <li class="tab-btn <?php if (isset($_GET['type']) && $_GET['type'] == 'listing') echo 'active-btn'; ?>" data-tab="#listing" data-type="listing">Listing</li>
         </ul>

         <div class="tabs-content">
            <div class="tab <?php if (isset($_GET['type']) && $_GET['type'] == 'listing') echo 'active-tab'; ?>" id="listing">
               ...
               <div class="row">
                     ...
                     <div class="ls-outer">
                        ...
                        <div class="ls-switcher">
                           <div class="showing-result show-filters">
                              ...
                              <div class="text">Showing <strong>{{ $jobs->firstItem() }}-{{ $jobs->lastItem() }}</strong> of <strong>{{ $jobs->total() }}</strong> jobs</div>
                           </div>
                           <!-- 
                  <div class="sort-by">
                  ...
                  -->
                           ...
                           <form method="GET">
                              <div class="sort-by">
                                 <select name="per_page" onchange="this.form.submit()" class="chosen-select">
                        ...
                        <?php if ($jobs->total() > $jobs->perPage()) { ?>
                           <nav class="ls-pagination mb-5">
                              <ul class="pagination">
                                 ...
                                 @else
                                 <li class="prev"><a href="{{ $jobs->appends(request()->except('page'))->previousPageUrl() }}" rel="prev"><i class="fa fa-arrow-left"></i></a></li>
                                 @endif
                                 ...
                                 @else
                                 <li><a href="{{ $jobs->appends(request()->except('page'))->url($page) }}">{{ $page }}</a></li>
                                 @endif
                                 @endforeach
                                 @endif
                                 @endforeach
                                 ...
                                 <li class="text"><a href="{{ $jobs->appends(request()->except('page'))->nextPageUrl() }}" rel="next"><i class="fa fa-arrow-right"></i></a></li>
                                 @else
                        ...
                        <div class="call-to-action-four style-two">
                           ...
                           <div class="image" style="background-image: url({{ asset('public/assets/images/resource/image-1.png') }});"></div>
                        </div>
                        <!-- End Call To Action -->
                     </div>
                  </div>
            ...
            <!--Tab-->
            <div class="tab <?php if ((isset($_GET['type']) && $_GET['type'] == 'heatmap') || (!isset($_GET['type']))) echo 'active-tab'; ?>" id="heatMap">
