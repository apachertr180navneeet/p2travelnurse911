      ...
      <div class="row">
         ...
         <div class="work-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box border h-100 d-flex flex-column">
               <figure class="image"><img src="{{ asset('public/assets/images/resource/work-2.png') }}" alt=""></figure>
         ...
         <div class="work-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box border h-100 d-flex flex-column">
               <figure class="image"><img src="{{ asset('public/assets/images/resource/work-1.png') }}" alt=""></figure>
         ...
         <div class="work-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box border h-100 d-flex flex-column">
               <figure class="image"><img src="{{ asset('public/assets/images/resource/work-3.png') }}" alt=""></figure>
