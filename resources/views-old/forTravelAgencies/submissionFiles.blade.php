   ...
   <div class="auto-container">
      <div class="row mb-5">
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
               <figure class="image"><img src="{{ asset('public/assets/images/media/Post-24-01.jpg') }}" alt=""></figure>
      ...
      <div class="row wow fadeInUp mb-5">
         ...
         <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
               ...
               <ul class="list-style-three mt-0">
                  ...
                  <li><strong class="color-style-3">Continuing Education Certificates</strong> : Ensure that candidates have uploaded any continuing education certificates. These demonstrate their commitment to professional development and staying current in their field.</li>
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-31-01.jpg') }}" alt=""></figure>
         </div>
      </div>
