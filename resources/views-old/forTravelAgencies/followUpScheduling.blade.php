...
<section class="page-title">
   <div class="auto-container">
      <div class="title-outer">
         ...
         @include('components.travelAgenciesMenus', ['currentPage' => 'followUpScheduling'])
      </div>
   </div>
</section>
<!--End Page Title-->
         ...
         <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column pt-3">
               ...
               <ul class="list-style-one">
                  ...
                  <li><strong>Choose convenient time slots</strong></li>
                  <li><strong>Track all scheduled follow ups </strong></li>
                  <li><strong>View and manage upcoming follow ups</strong></li>
                  <li><strong>Easily reschedule if necessary</strong></li>
                  <li><strong>Automated reminders and updates</strong></li>
                  <li><strong>Seamless calendar integration</strong></li>
               </ul>
            </div>
         </div>
