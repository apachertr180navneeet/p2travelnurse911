...
<section class="page-title">
   <div class="auto-container">
      <div class="title-outer">
         <h1>Efficient Staffing Solutions for Your Healthcare Facility</h1>
...
<section class="call-to-action-two style-two " style="background-image: url({{ asset('public/assets/images/background/4.jpg')}});">
   <div class="auto-container wow fadeInUp">
      <div class="sec-title light text-center">
         <h1 class="mb-3">Ready to discover your next great hire?</h1>
   ...
   <div class="auto-container">
      ...
      <div class="row">
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-11.jpg')}}" alt=""></figure>
         </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 order-2">
            <div class="inner-column">
               <figure class="image-box wow fadeInLeft">
                  <img src="{{ asset('public/assets/images/media/Post-12.jpg') }}" />
               </figure>
            </div>
         </div>
         ...
         <div class="content-column col-lg-6 col-md-12 col-sm-12 wow fadeInRight">
            ...
            <div class="mt-2 text-center">
               <a href="{{ config('custom.client_login_url') }}" class="theme-btn btn-style-one">Hire Now</a>
            </div>
            -->
         </div>
      </div>
