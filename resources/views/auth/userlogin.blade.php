        ...
        <div class="container">
            <div class="row justify-content-center w-100 align-items-center h-100">
                ...
                <div class="bg-white col-md-8 col-lg-6 col-xl-4 py-3 rounded shadow-lg">
                    <div class="p-3">
                        <div class="auth-brand text-center text-lg-start">
                            <div class="auth-brand">
                                <a class="logo logo-dark text-center" href="https://staging.travelnurse911.com/frontend/">
                                    <span class="logo-lg">
                                    <img src="https://web.travelnurse911.com/public/assets/images/logo.png" alt="logo" width="160">
                                    </span>
                                </a>                               
                            </div>
                        </div>
                    ...
                    @endif
                        <form  action="{{ route("auth.user.login") }}" class="sign-form widget-form" method="POST">
                        @csrf
                            <div class="mb-3">
