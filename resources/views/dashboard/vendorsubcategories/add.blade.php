...
@section('title', 'New Vendor Category - ' . config('app.name'))
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add Vendor Subcategory</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route("dashboard.home") }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route("dashboard.vendorsubcategories.index") }}">All Subcategory</a></li>
                        <li class="breadcrumb-item active">Add Vendor Subcategory</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add Vendor Subcategory   </h3>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route("dashboard.vendorsubcategories.store") }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="vendor_category_id" id="vendor_category_id">
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->id }}" {{ old('vendor_category_id') == $category->id ? 'selected' : '' }}>
                                                        {{ $category->title }}
                                                    </option>
                                                @endforeach
                                            </select>
