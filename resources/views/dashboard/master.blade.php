...
<head>
    ...
    <title>@yield("title") - News Feed</title>
...
<body class="hold-transition sidebar-mini layout-fixed"> <!-- sidebar-collapse -->
    <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <span class="fa-2x brand-text font-weight-bold px-2">News Feed</span>
        </div>
    ...
    <script src="{{ asset("public/assets/dashboard/plugins/jquery-ui/jquery-ui.min.js") }}"></script>
    <script>
        // $.widget.bridge('uibutton', $.ui.button)
    </script>
    <script src="{{ asset("public/assets/dashboard/plugins/bootstrap/js/bootstrap.bundle.min.js") }}"></script>
    <script src="{{ asset("public/assets/dashboard/plugins/chart.js/Chart.min.js") }}"></script>
