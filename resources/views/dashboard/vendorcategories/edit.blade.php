                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.vendorcategories.update", $category->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mx-auto">
                                        {{-- <div class="form-group">
                                            ...
                                            <img id="imagepreview" class="img-fluid img-thumbnail mt-3" src="{{ asset("uploads/vendorcategory/".($category->image ?? "default.webp")) }}"/>
                                        </div> --}}
                                        <div class="form-group">
