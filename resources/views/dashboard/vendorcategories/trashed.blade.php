            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route("dashboard.vendorcategories.index") }}">All Categories</a></li>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                ...
                                <a href="{{ route('dashboard.vendorcategories.index') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route("dashboard.vendorcategories.restore", $category->id) }}" class="btn btn-success">Restore</a>
                                                    <form action="{{ route("dashboard.vendorcategories.delete", $category->id) }}" method="POST">
                                                        @method("DELETE")
                                                        @csrf
