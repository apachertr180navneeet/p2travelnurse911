                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" id="menuform" action="{{ route("dashboard.settings.menus.header.update") }}">
                                @csrf
...
@endsection
@section("style")
<link rel="stylesheet" href="{{ asset("public/assets/dashboard/plugins/menu-editor/css/styles.min.css") }}"/>
@endsection

@section("script")
<script src="{{ asset("public/assets/dashboard/plugins/menu-editor/js/menu-editor.min.js") }}"></script>
<script>
