                                ...
                                <div class="row">
                                    <div class="col-md-12 mx-auto">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="logo_darkpreview" src="{{ asset("public/uploads/logo/".$sitesettings->logo_dark) }}" class="d-block mb-3 img-fluid img-thumbnail bg-black"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="logo_lightpreview" src="{{ asset("public/uploads/logo/".$sitesettings->logo_light) }}" class="d-block mb-3 img-fluid img-thumbnail"/>
