                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mx-auto border p-1 d-flex flex-column justify-content-between">
                                    <div class="image">
                                        <img class="img-fluid" src="{{ asset("public/uploads/media/".$item->file_name) }}"/>
                                    </div>
                                    <div class="image-footer d-flex justify-content-center text-center mt-2">
                                        <button class="btn btn-primary copybtn" data-clipboard-text="{{ asset("public/uploads/media/".$item->file_name) }}">Copy Link</button>
...
<script src="{{ asset("public/assets/dashboard/plugins/clipboardjs/clipboard.min.js") }}"></script>
<script>
