...
<section class="job-section">
   <div class="small-container">
      <div class="image-column">
         <figure class="image"><img class="border" src="{{ asset('public/assets/images/media/Post_32-01.jpg') }}" alt="Compliance Documentation Management"></figure>
      </div>
   </div>
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 mb-5">
            <div class="testimonial-block m-0 p-0 h-100">
               <div class="inner-box h-100">
                  ...
                  <div class="text mb-3 text-dark">Our document safe allows you to securely store your documents so that you are prepared to submit them to Recruiters when you accept a position. This speeds up the onboarding time and allows you to start assignments sooner than later. </div>
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 mb-5 ">
            <div class="testimonial-block m-0 p-0 h-100">
               <div class="inner-box h-100">
                  ...
                  <div class="text mb-3 text-dark">Easily upload, organize, and manage compliance documents with our user-friendly system. Keep track of certifications, licenses, and other critical paperwork, ensuring that all your documents are accessible whenever needed. </div>
                  <ul class="list-style-one">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 mb-5">
            <div class="testimonial-block m-0 p-0 h-100">
               <div class="inner-box h-100">
                  ...
                  <div class="text mb-3 text-dark">Effortlessly manage your certifications with our advanced tracking tools. Keep track of expiration dates, get renewal alerts, and maintain a complete record of your credentials. Prevent certification lapses and stay ready for new opportunities. </div>
                  <ul class="list-style-one">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 mb-5">
            <div class="testimonial-block m-0 p-0 h-100">
               <div class="inner-box h-100">
                  ...
                  <div class="text mb-3 text-dark">Ensure you never miss a critical compliance deadline with our automated alert system. Receive notifications for key dates, such as license renewals, certification expirations, and required training updates. Stay informed and proactive with timely reminders to keep your credentials up to date. </div>
                  <ul class="list-style-one">
