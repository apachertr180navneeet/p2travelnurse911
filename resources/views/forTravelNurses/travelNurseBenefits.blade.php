   ...
   <div class="small-container">
      <div class="row wow fadeInUp">
         ...
         <div class="image-column col-lg-12 col-md-12 col-sm-12 d-flex align-items-center m-0">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-25-01.jpg') }}" alt="Travel Nurse Benefits"></figure>
         </div>
   ...
   <div class="auto-container">
      ...
      <div class="row wow fadeInUp">
         ...
         <div class="job-block col-lg-12 col-md-12 col-sm-12">
            <div class="inner-box h-100 bg-light">
               <div class="content pl-0">
                  <h4><span class="color-style-3">Exclusive Job Board for Travel Nurses</span></h4>
                  <ul class="list-style-one mt-3 row">
                     <div class="col-lg-6 col-md-12 col-sm-12">
                        <li><span><strong>Easy Job Application</strong> : One-click applications for multiple positions.</span></li>
                        <li><span><strong>Wide Range of Positions</strong> : From short-term contracts to long-term assignments across the country.</span></li>
                     </div>
                     <div class="col-lg-6 col-md-12 col-sm-12">
                        <li><span><strong>Tailored Opportunities</strong> : 100% dedicated to RNs, LPNs, and CNAs seeking travel assignments.
                           </span></li>

                        <li class="mb-0"><span><strong>Personalized Job Matches</strong> : Our algorithm highlights job opportunities that fit your skills and preferences.
                           </span></li>
                     </div>
                  </ul>
               </div>
         ...
         <div class="job-block col-lg-6 col-md-12 col-sm-12">
            <div class="inner-box h-100 bg-light">
               <div class="content pl-0">
                  <h4><span class="color-style-3">Financial Benefits</span></h4>
                  <ul class="list-style-one mt-3">
                     <li><span><strong>Competitive Pay Rates</strong> : Find jobs that offer competitive compensation and benefits.</span></li>
                     <li><span><strong>Bonus Programs</strong> : Access to sign-on bonuses, referral bonuses, and completion bonuses.</span></li>
                  </ul>
               </div>
            </div>
         </div>
         ...
         <div class="job-block col-lg-6 col-md-12 col-sm-12">
            <div class="inner-box h-100 bg-light">
               <div class="content pl-0">
                  <h4><span class="color-style-3">Seamless Communication Tools</span></h4>
                  <ul class="list-style-one mt-3">
                     <li><span><strong>Follow Up & Messaging System</strong> : Ensures direct and efficient communication between travelers and recruiters.</span></li>
                     <li><span><strong>Real-Time Updates</strong> : Receive instant notifications on job applications, interview requests, and recruiter messages.</span></li>
                  </ul>
               </div>
            </div>
         </div>
         ...
         <div class="job-block col-lg-6 col-md-12 col-sm-12">
            <div class="inner-box h-100 bg-light">
               <div class="content pl-0">
                  <h4><span class="color-style-3">Document Management</span></h4>
                  <ul class="list-style-one mt-3">
                     <li><span><strong>Document Safe</strong> : Securely store and share essential documents like licenses, certifications, and resumes.</span></li>
                     <li><span><strong>Expedited Onboarding</strong> : Quick and easy access to your documents speeds up the hiring process.</span></li>
                  </ul>
               </div>
            </div>
         </div>
         ...
         <div class="job-block col-lg-6 col-md-12 col-sm-12">
            <div class="inner-box h-100 bg-light">
               <div class="content pl-0">
                  <h4><span class="color-style-3">24/7 Support</span></h4>
                  <ul class="list-style-one mt-3">
                     <li><span><strong>Round-the-Clock Assistance</strong> : Our dedicated support team is available any time to help with any issues or inquiries.</span></li>
                     <li><span><strong>Comprehensive Help Center</strong> : Access to FAQs, tutorials, and guides to assist with common questions and processes.</span></li>
                  </ul>
               </div>
            </div>
         </div>
...
<section class="about-section-two secion-3 pb-5">
   <div class="auto-container">
      ...
      <div class="text-center">
         <a href="{{ config('custom.register_url') }}" class="theme-btn btn-style-one">Explore Jobs</a>
      </div>
   </div>
</section>
