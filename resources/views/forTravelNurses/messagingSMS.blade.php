      ...
      <div class="row">
         ...
         <div class="news-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box bg-white h-100">
               <div class="image-box">
                  <figure class="image"><img src="{{ asset('public/assets/images/media/Post-34-01.jpg') }}" alt="Best Travel Nurse Jobs"></figure>
               </div>
         ...
         <div class="news-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box bg-white h-100">
               <div class="image-box">
                  <figure class="image"><img src="{{ asset('public/assets/images/media/Post-38.jpg') }}" alt="Travel Nursing Jobs In USA"></figure>
               </div>
               <div class="lower-content">
         ...
         <div class="news-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box bg-white h-100">
               <div class="image-box">
                  <figure class="image"><img src="{{ asset('public/assets/images/media/Post-35.jpg') }}" alt="Best Travel Nursing Jobs"></figure>
               </div>
               <div class="lower-content">
         ...
         <div class="news-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box bg-white h-100">
               <div class="image-box">
                  <figure class="image"><img src="{{ asset('public/assets/images/media/Post-36.jpg') }}" alt="Find Travel Nurse Jobs"></figure>
               </div>
               <div class="lower-content">
