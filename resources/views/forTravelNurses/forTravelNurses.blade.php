...
@section('title', 'Registered Travel Nurse Jobs | Join Travel Nurse 911')
@section('description', 'The fastest growing job site for Travel Nurses, bridging the gap between Travel agencies and hospitals. Sign up with Travel Nurse 911. Receive job alerts!.')
      ...
      <div class="row">
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            ...
            <figure class="image wow fadeInLeft">
               <img src="{{ asset('public/assets/images/media/Post-5-01.jpg')}}" alt="fastest growing job site for Travel Nurses">
            </figure>
         </div>
      ...
      <div class="cards">
            ...
            <a href="{{ route('travel-nurse-benefits') }}">
               <div class="inner-box p-0 border">
                  <div class="content-box text-center p-4 p-lg-5">
                     <h2 class="mb-3 font-weight-bold">Travel Nurse Benefits </h2>
                  ...
                  <div class="image-box order-2 ">
                     <figure class="image justify-content-center align-items-center w-100 h-100">
                        <img src="{{ asset('public/assets/images/media/Post-6-01.jpg') }}" class="w-100 h-100" alt="Travel Nurse Benefits"/>
                     </figure>
                  </div>
               </div>
            </a>
         ...
         <div class="news-block-two mb-4 pt-0  " data-index="0">
            <a href="{{ route('professional-profile') }}">
               <div class="inner-box p-0 border">
                  <div class="content-box text-center p-4 p-lg-5">
                     <h2 class="mb-3 font-weight-bold">Professional Profile</h2>
                     <h5 class="text-dark font-weight-bold" style="line-height: 1.5;">
         ...
         <div class="news-block-two mb-4 pt-0  " data-index="0">
            <a href="{{ route('document-safe') }}">
               <div class="inner-box p-0 border">
                  <div class="content-box text-center p-4 p-lg-5">
                     <h2 class="mb-3 font-weight-bold">Document Safe</h2>
                     <h5 class="text-dark font-weight-bold" style="line-height: 1.5;">
         ...
         <div class="news-block-two mb-4 pt-0  " data-index="0">
            <a href="{{ route('application-status-tracking') }}">
               <div class="inner-box p-0 border">
                  <div class="content-box text-center p-4 p-lg-5">
                     <h2 class="mb-3 font-weight-bold">Application Status Tracking</h2>
                     <h5 class="text-dark font-weight-bold" style="line-height: 1.5;">
         ...
         <div class="news-block-two mb-4 pt-0  " data-index="0">
            <a href="{{ route('messaging-sms') }}">
               <div class="inner-box p-0 border">
                  <div class="content-box text-center p-4 p-lg-5">
                     <h2 class="mb-3 font-weight-bold">Messaging & SMS</h2>
                     <h5 class="text-dark font-weight-bold" style="line-height: 1.5;">
...
<section class="steps-section">
   <div class="auto-container">
      <div class="row wow fadeInUp">
         ...
         <!-- Image Column -->
         <div class="image-column col-lg-6 col-md-12 col-sm-12 ">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-10.jpg') }}" alt="Local Travel Nurse Jobs"></figure>
         </div>
         <!-- content Column -->
         <div class="content-column col-lg-6 col-md-12 col-sm-12">
