...
<section class="process-section">
   <div class="small-container">
      ...
      <div class="image-column mb-5">
         <figure class="image"><img class="border" src="{{ asset('public/assets/images/media/Post-30-01.jpg') }}" alt="Travel Nurse Agencies"></figure>
      </div>
      ...
      <div class="row wow fadeInUp">
         ...
         <div class="process-block col-lg-4 col-md-6 col-sm-12">
            <div class="icon-box"><img src="{{ asset('public/assets/images/resource/process-1.png') }}" alt="Organize Daily Tasks"></div>
         ...
         <!-- Process Block -->
         <div class="process-block col-lg-4 col-md-6 col-sm-12">
            <div class="icon-box"><img src="{{ asset('public/assets/images/resource/process-2.png') }}" alt="Set Priorities and Deadlines"></div>
         ...
         <!-- Process Block -->
         <div class="process-block col-lg-4 col-md-6 col-sm-12">
            <div class="icon-box"><img src="{{ asset('public/assets/images/resource/process-3.png') }}" alt="Collaborate and Assign Tasks"></div>
