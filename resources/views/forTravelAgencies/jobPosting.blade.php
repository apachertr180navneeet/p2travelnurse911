      ...
      <div class="row">
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
               <figure class="image"><img src="{{ asset('public/assets/images/media/Post-22.jpg') }}" alt="Travel Nurse Jobs Near Me"></figure>
            </div>
         </div>
         ...
         <div class="job-block-two mt-2 col-lg-4 col-md-12 col-sm-12">
            <div class="inner-box p-4 h-100">
          ...
          <div class="mt-2 col-lg-12 col-md-12 col-sm-12 text-center">
            <a href="{{ route('pilot-partner-signup') }}" class="theme-btn btn-style-one">Start Hiring Today</a>
         </div>
...
<section class="job-section-four">
   <div class="auto-container">
      <div class="row wow fadeInUp">
         ...
         <!-- content Column -->
         <div class="content-column col-lg-6 col-md-12 col-sm-12 mt-lg-5">
            <div class="inner-column">
               <div class="sec-title mb-2">
                  <h2 class="color-style-1">How it Works</h2>
               </div>

               <ul class="steps-list mt-0 mt-lg-3">

                  <li class="mb-2 mb-lg-4"><span class="count">1</span><span class="color-style-3">Create a Job Posting</span>
                  ...
                  <li class="mb-2 mb-lg-4"><span class="count">2</span><span class="color-style-3">Manage Applications</span>
         ...
         <!-- Image Column -->
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-10.jpg') }}" alt="Nurse Recruiter Jobs"></figure>
         </div>
