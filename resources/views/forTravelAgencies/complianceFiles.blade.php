...
<section class="page-title">
   <div class="auto-container">
      <div class="title-outer">
         ...
         @include('components.travelAgenciesMenus', ['currentPage' => 'complianceFiles'])
      </div>
   </div>
</section>
<!--End Page Title-->
   ...
   <div class="auto-container">
      <div class="row mb-5">
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image wow fadeInLeft"><img src="{{ asset('public/assets/images/media/Post-26.jpg') }}" alt="Healthcare Facilities"></figure>
      ...
      <div class="row mb-5">
         ...
         <!-- Image Column -->
         <div class="image-column col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image wow fadeInLeft"><img src="{{ asset('public/assets/images/media/Post-27-01.jpg') }}" alt="Best Travel Nursing Agencies"></figure>
      ...
      <div class="row mb-5">
         ...
         <!-- Image Column -->
         <div class="image-column col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image wow fadeInLeft"><img src="{{ asset('public/assets/images/media/Post-28-01.jpg') }}" alt="Travel Nursing Agency Near Me"></figure>
