   ...
   <div class="auto-container">
      <div class="title-outer">
         ...
         <ul class="page-breadcrumb">
            <li>Efficiently Manage Your Hiring Process with Seamless Applicant Tracking</li>
         </ul>
         @include('components.healthcareFacilitiesMenus', ['currentPage' => 'applicantTrackingSystem'])
      </div>
   </div>
</section>
<!--End Page Title-->
      ...
      <div class="row">
         ...
         <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
            <div class="inner-column wow fadeInUp">
               <div class="sec-title">
                  <h2 class="color-style-1">Streamline Your Recruitment Process with Our Advanced Candidate Tracking System</h2>
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <figure class="image wow fadeInLeft"><img src="{{ asset('public/assets/images/media/Post-23.jpg') }}" alt=""></figure>
