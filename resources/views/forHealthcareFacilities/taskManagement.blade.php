...
<section class="page-title">
   <div class="auto-container">
      <div class="title-outer">
         ...
         @include('components.healthcareFacilitiesMenus', ['currentPage' => 'taskManagement'])
      </div>
   </div>
</section>
<!--End Page Title-->
...
<section class="about-section secion-3">
   <div class="auto-container">
      <div class="row wow fadeInUp">
         ...
         <!-- Image Column -->
         <div class="image-column col-lg-12 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image"><img src="{{ asset('public/assets/images/media/Post-30-01.jpg') }}" alt=""></figure>
         </div>
