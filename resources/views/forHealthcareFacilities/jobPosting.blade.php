...
<section class="page-title">
   <div class="auto-container">
      <div class="title-outer">
         ...
         @include('components.healthcareFacilitiesMenus', ['currentPage' => 'jobPosting'])
      </div>
   </div>
</section>
<!--End Page Title-->
      ...
      <div class="row">
         ...
         <div class="content-column col-lg-6 col-md-12 col-sm-12 mb-5">
            <div class="inner-column wow fadeInUp pl-3">
               <div class="sec-title">
                  <h2 class="color-style-1">Quickly Find the Ideal Travel Nurses
                  </h2>
         ...
         <div class="job-block-two mt-2 col-lg-4 col-md-12 col-sm-12">
          ...
          <div class="job-block-two mt-2 col-lg-12 col-md-12 col-sm-12 text-center">
