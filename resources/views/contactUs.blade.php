...
@section('title', 'Contact us | Travel Nurse 911')
@section('description',
    'Recruiting? Advertise your jobs to thousands of active users. Contact Travel Nurse 911 Now!')
      ...
      <div class="upper-box mt-0 pt-0">
         <div class="row">
            ...
            <div class="contact-block col-lg-4 col-md-6 col-sm-12 text-center">
               <div class="inner-box">
                  <span class="icon"><img src="{{ asset('public/assets/images/icons/placeholder.svg')}}" alt="Location"></span>
                  <h4>Address</h4>
...
-->
            <div class="contact-block col-lg-6 col-md-6 col-sm-12 text-center">
               <div class="inner-box">
                  <span class="icon"><img src="{{ asset('public/assets/images/icons/smartphone.svg')}}" alt="Call Us"></span>
                  <h4>Call Us</h4>
            ...
            <div class="contact-block col-lg-6 col-md-6 col-sm-12 text-center">
               <div class="inner-box">
                  <span class="icon"><img src="{{ asset('public/assets/images/icons/letter.svg')}}" alt="Email"></span>
                  <h4>Email</h4>
...
<section class="call-to-action style-two">
   <div class="auto-container">
      <div class="outer-box">
         ...
         <div class="image-column" style="background-image: url({{ asset('public/assets/images/resource/image-1.png')}});" alt="Nurse Jobs Online">
            <figure class="image"><img src="{{ asset('public/assets/images/resource/image-1.png')}}" alt="Travel Nurse Job Postings"></figure>
         </div>
      </div>
   </div>
</section>
