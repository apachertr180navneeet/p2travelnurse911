...
@section('title', 'Best Travel Nursing Job Board USA | Travel Nurse 911')
@section('description',
    'Find your next travel nursing adventure! Explore high-paying jobs nationwide, with flexible contracts, and top benefits. Start your journey today!')
...
<?php
if (isset($announcement) && !empty($announcement->description)) {
?>
            ...
            <div class="inner-column wow fadeInUp py-0">
               <div class=" image-box position-relative">
                  <figure class=" main-image wow fadeIn mb-lg-0 mt-0">
                     <img src="{{ asset('public/assets/images/media/banner-1.jpg') }}" alt="Travel Nursing Jobs" />
                  </figure>
         ...
         <?php foreach ($jobs as $row) { ?>
            <div class="job-block col-lg-6 col-md-12 col-sm-12">
               <a href="{{ route('job',$row->unique_id) }}" class="job-outer-link">
                  <div class="inner-box bg-light h-100 job-inner-box">
...
<section class="registeration-bannerss job-categories secion-10" style="background-color:#F0F5F7;">
   <div class="auto-container">
       <div class="sec-title text-center">
         <h1 class="color-style-1">Best Travel Nursing Job Board</h1>
      </div>
   ...
   <div class="auto-container">
      <div class="row">
         ...
         <div class="image-column col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
            <figure class="image-box wow fadeInLeft"><img src="{{ asset('public/assets/images/media/Post-1.jpg') }}" alt="Travel Nurse Jobs USA" /></figure>
         </div>
